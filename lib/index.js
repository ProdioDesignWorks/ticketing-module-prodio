    ...
    if (!isJson(payload)) {
        ...
        if (!isJson(payload)) {
            ...
            if (isNull(payload.businessId)) {
                ...
                var url = BASE_URL + '/ticketActions/list?businessId=' + payload.businessId;
                axios.get(url, payload).then(function (response) {
                    return callback(response);
                }).catch(function (error) {
                    var json = stringify(error);
    ...
    if (!isJson(payload)) {
        ...
        if (!isJson(payload)) {
            ...
            if (isNull(payload.value)) {
                ...
                var url = BASE_URL + '/ticketActions/remove?ticketActionValue=' + payload.value + '&businessId=' + payload.businessId;
                axios.delete(url, payload).then(function (response) {
                    return callback(response);
                }).catch(function (error) {
                    var json = stringify(error);
